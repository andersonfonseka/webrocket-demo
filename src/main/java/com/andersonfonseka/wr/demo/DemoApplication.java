...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		webApplication.setMessageBundle(messageBundle);
		webApplication.setDefaultMessageBundle(Locale.getDefault().toString());
		
		webApplication.setStartPage(MoviePage.class);
		webApplication.setErrorPage(ErrorPage.class);
